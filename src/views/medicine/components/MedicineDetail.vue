                ...
                <el-row>
                  <el-col v-show="isEdit" :span="24">
                    <el-form-item label-width="90px" label="项目Id:" class="postInfo-container-item">
                      <el-input v-model="postForm.projectName" placeholder="项目" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item
                      ...
                      prop="revenue"
                    >
                      <el-input v-model="postForm.revenue" placeholder="收入/支出" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item label-width="90px" label="负责人:" class="postInfo-container-item" prop="master">
                      <el-input v-model="postForm.master" placeholder="负责人" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                  <el-col v-show="isEdit" :span="24">
                    <el-form-item label-width="90px" label="类型:" class="postInfo-container-item">
                      <el-input v-model="postForm.balanceType" placeholder="类型" />
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-row>
